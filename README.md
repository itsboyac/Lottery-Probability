# Lottery Probability
This project explores the probability of hitting the jackpot in lottery. We will go through functions setups using mathematical concpets in probability, then testing the function on the real world dataset. 
## Source
